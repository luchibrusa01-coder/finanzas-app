...
import { Ingreso, Gasto, Categoria, Activo, AsignacionInversion, Config } from '@/types'
...
export function AppProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    localStorage.setItem('finanzas_v1', JSON.stringify({
      ingresos, gastos, categorias, activos, asignaciones, config,
    }))
  }, [ingresos, gastos, categorias, activos, asignaciones, config, loaded])
